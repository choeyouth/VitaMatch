        ...
        itemStr += `
            ...
            <div class="map-info">
                <div class="pharmacy-time">
                    <span>⦁&nbsp;&nbsp;&nbsp;</span>
                    <span>${pharmacy.open ? '영업중' : '영업 종료'}&nbsp;&nbsp;&nbsp;</span>
...
function showPharmacyInfo(result, etc) {
	...
	const str = `
		...
		<div class="pharmacy-detail-info">
			<h2>${pharmacy.name}</h2>	
			<div class="map-info">
				<div class="pharmacy-time"><span>⦁&nbsp;&nbsp;&nbsp;</span><span id="isOpen">${pharmacy.open ? '영업중' : '영업 종료'}&nbsp;&nbsp;&nbsp;</span>(${pharmacy.openTime} ~ ${pharmacy.closeTime})</div>		
